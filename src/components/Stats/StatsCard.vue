<template>
  <v-flex md3 sm6 xs12>
    <v-card class="mb-3 mx-auto">
      ...
      >
        <v-icon size="70" class="white--text" left>{{ icon }}</v-icon>
      </v-sheet>
...
<script>
  import StatsCardProgress from './StatsCardProgress';

  export default {
    name: 'stats-card',
    props: ['value', 'label', 'icon', 'extras', 'unit', 'color'],
    components: {
      'stats-card-progress': StatsCardProgress
    },
    computed: {
      extrasClassName() {
